...
export function OrderModal({ isOpen, onClose, rank }: OrderModalProps) {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-800/95 rounded-2xl p-8 max-w-md w-full m-4 relative">
        ...
        <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
          <h3 className="text-xl font-semibold text-white mb-2">{rank.name} Rank</h3>
          <p className="text-emerald-400 text-lg">${rank.price}</p>
        </div>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-400 mt-2">Amount: ${rank.price}</p>
        </div>
